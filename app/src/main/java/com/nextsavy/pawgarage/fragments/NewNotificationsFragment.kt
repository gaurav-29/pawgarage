...
import com.nextsavy.pawgarage.databinding.FragmentNewNotificationsBinding
...
class NewNotificationsFragment : Fragment(), RecyclerViewPagingInterface<NotificationDTO> {
    private lateinit var binding: FragmentNewNotificationsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNewNotificationsBinding.inflate(inflater, container, false)
            ...
            if (!reachedEnd) {
                ...
                val query = if (lastDocument == null) {
                    Firebase.firestore.collection(CollectionNotifications.name)
                        ...
                        .whereEqualTo(CollectionNotifications.kNotificationType, CollectionNotifications.NEW_PROFILE)
                ...
                query.get().addOnSuccessListener { querySnapshot ->
                    ...
                    for (notification in notificationList) {
                        if (!notification.animalDocId.isNullOrBlank() && notification.notificationType == CollectionNotifications.NEW_PROFILE) {
