...
import com.nextsavy.pawgarage.databinding.FragmentDewormingNotificationsBinding
...
class DewormingNotificationsFragment : Fragment(),
    RecyclerViewPagingInterface<NotificationDTO> {

    private lateinit var binding: FragmentDewormingNotificationsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDewormingNotificationsBinding.inflate(inflater, container, false)
            ...
            if (!reachedEnd) {
                ...
                val query = if (lastDocument == null) {
                    Firebase.firestore.collection(CollectionNotifications.name)
                        ...
                        .whereEqualTo(CollectionNotifications.kNotificationType, CollectionNotifications.DEWORMING)
