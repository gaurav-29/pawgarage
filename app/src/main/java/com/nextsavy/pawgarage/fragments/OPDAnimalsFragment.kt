...
import com.nextsavy.pawgarage.databinding.FragmentOPDAnimalsBinding
...
class OPDAnimalsFragment : Fragment(), RecyclerViewPagingInterface<AnimalDTO> {

    private lateinit var binding: FragmentOPDAnimalsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOPDAnimalsBinding.inflate(inflater, container, false)
    ...
    private fun setupAnimalRV() {
        ...
        binding.opdProfilesRV.layoutManager = layoutManager
        binding.opdProfilesRV.adapter = adapter
        // Manthan 24-11-2023
        ...
        if (Helper.isInternetAvailable(requireContext())) {
            ...
            if (!reachedEnd) {
                ...
                var query = Firebase.firestore.collection(CollectionAnimals.name)
                    ...
                    .whereEqualTo(CollectionAnimals.kType, CollectionAnimals.OPD)
