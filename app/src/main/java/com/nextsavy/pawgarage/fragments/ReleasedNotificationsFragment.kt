...
import com.nextsavy.pawgarage.databinding.FragmentReleasedNotificationsBinding
...
class ReleasedNotificationsFragment : Fragment(), RecyclerViewPagingInterface<NotificationDTO> {

    private lateinit var binding: FragmentReleasedNotificationsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentReleasedNotificationsBinding.inflate(inflater, container, false)
            ...
            if (!reachedEnd) {
                ...
                val query = if (lastDocument == null) {
                    Firebase.firestore.collection(CollectionNotifications.name)
                        ...
                        .whereIn(CollectionNotifications.kNotificationType, listOf(CollectionNotifications.RELEASED, CollectionNotifications.ADOPTED, CollectionNotifications.DEATH))
